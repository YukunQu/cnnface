...
if __name__ == '__main__':
    prepath = r'J:\face in noise\faceRepresentationExp\exp\stimulus\gender\part12'
    output = r'J:\face in noise\faceRepresentationExp\exp\stimulus\gender\part12.csv'
