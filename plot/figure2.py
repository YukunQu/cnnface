...
cis_vgg = np.load(r'D:\cnnface\Data_sorted\vggface_act\ci\data/cis_vgg_act.npy')
...
cbar.ax.set_yticklabels(['0', '1'], fontsize=28)
cbar.ax.set_yticks(np.arange(0, 1.1, 1))
plt.savefig(r'F:\研究生资料库\项目五：AI\文章图\img\Figure2/figure2_new_act.jpg',dpi=300)
