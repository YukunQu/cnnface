...
cis_alexnet = np.load(r'D:\cnnface\Data_sorted\vgg16\ci\data/cis.npy')
...
plt.savefig(r'D:\cnnface\Data_sorted\vgg16\ci\img/cis_vgg16.jpg',dpi=300)
plt.show()

#%%
ci_alexnet = np.load(r'D:\cnnface\Data_sorted\alexnet\ci\data/ci_alexnet.npy')
save_path = r'F:\研究生资料库\项目五：AI\文章图\img\Figure4/ci_alexnet.jpg'
