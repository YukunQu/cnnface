...
p_minsignIndex = np.squeeze(np.argwhere(p_signIndex == p_signIndex.max()))
...
np.save(r'D:\cnnface\gender_analysis\supplementray_analysis\result\p_sign/cohensd_sum.npy', dis_sum)
np.save(r'D:\cnnface\gender_analysis\supplementray_analysis\result\p_sign/p_signIndex.npy',p_signIndex)
# np.save(r'D:\cnnface\gender_analysis\human_result\para_significant/p_signIndexFDR.npy', p_signIndexFDR)
np.save(r'D:\cnnface\gender_analysis\supplementray_analysis\result\p_sign/p_minsignIndex.npy', p_minsignIndex)
